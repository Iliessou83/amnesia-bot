...
read -p "Chat IDs autorisés (séparés par virgule) : " ALLOWED_IDS
...
sudo systemctl enable amnesia-bot amnesia-crons
sudo systemctl start amnesia-bot amnesia-crons

echo ""
echo "════════════════════════════════════════"
echo "✅ Amnesia Bot déployé avec succès !"
echo ""
echo "Commandes utiles :"
echo "  sudo systemctl status amnesia-bot"
echo "  sudo journalctl -u amnesia-bot -f"
echo "════════════════════════════════════════"
